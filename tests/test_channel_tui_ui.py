...
def ui():
    root = "/Users/mac/Desktop/jarvis/plugins/channel-tui/ui.py"
    ...
    sys.modules["bigfont_data"] = importlib.util.module_from_spec(
        importlib.util.spec_from_file_location("bigfont_data_test", "/Users/mac/Desktop/jarvis/plugins/channel-tui/bigfont_data.py")
    )
    sys.modules["whale_data"] = importlib.util.module_from_spec(
        importlib.util.spec_from_file_location("whale_data_test", "/Users/mac/Desktop/jarvis/plugins/channel-tui/whale_data.py")
    )
    importlib.util.spec_from_file_location("whale_data_test", "/Users/mac/Desktop/jarvis/plugins/channel-tui/whale_data.py").loader.exec_module(sys.modules["whale_data"])
    importlib.util.spec_from_file_location("bigfont_data_test", "/Users/mac/Desktop/jarvis/plugins/channel-tui/bigfont_data.py").loader.exec_module(sys.modules["bigfont_data"])
