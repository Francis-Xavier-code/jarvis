...
### Changed
- buffered mode (JARVIS_NO_STREAM=1) renders replies through a registered `render` service (e.g. mdcat-render) when present; falls back to the built-in renderer otherwise (by JARVIS <jarvis@jarvis.local>)
